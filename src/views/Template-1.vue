<template>
  <div class="max-w-5xl mx-auto">
    <div class="flex shadow-lg">
      <div
        class="w-1/3 min-h-screen bg-gray-800 text-gray-100 p-12 text-center"
      >
      ...
      <div class="w-2/3 min-h-screen bg-gray-100">
...
export default {
  ...
  computed: {
    initials() {
      const first = this.nameInitial(this.data.name.first);
      const middle = this.nameInitial(this.data.name.middle);
      const last = this.nameInitial(this.data.name.last);
